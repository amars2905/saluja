...
public class OppoFragment extends Fragment implements View.OnClickListener {
    private View view;
    ...
    public void init(){
        ...
        bt_layout_loadmore = (Button)view.findViewById(R.id.bt_layout_loadmore);
        bt_layout_loadmore.setOnClickListener(this);
    ...
    private class GetContacts extends AsyncTask<Void, Void, Void> {
        ...
        protected Void doInBackground(Void... arg0) {
            ...
            String jsonStr = sh.makeServiceCall(URL_PRODUCT_LIST1+page);
